...
namespace Spacing {
    ...
    inline constexpr int paddingS = 6;
    inline constexpr int paddingM = 8;
    inline constexpr int paddingL = 12;
    inline constexpr int paddingXL = 20;

    // Element margins (external space between components)
    inline constexpr int marginXS = 4;
    ...
    // Component gaps (space between adjacent elements)
    inline constexpr int gapXS = 2;
